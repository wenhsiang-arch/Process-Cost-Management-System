...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    settings:'js/settings.js?v=20260923-2',
    uiTableControls:'js/ui-table-controls.js?v=20260923-2',
    uiSearchDropdown:'js/ui-search-dropdown.js?v=20260923-2',
    ...
    productImportImpact:'js/product-import-impact.js?v=20260923-2',
    productMasterEditor:'js/product-master-editor.js?v=20260923-2',
    productQuickEdit:'js/product-quick-edit.js?v=20260923-2',
    productGroupRuntime:'js/product-group-runtime.js?v=20260824-4',
    orderItemStore:'js/order-item-store.js?v=20260823-1',
    orderService:'js/order-service.js?v=20260923-2',
    orderProductionProgress:'js/order-production-progress.js?v=20260923-2',
    summary:'js/summary.js?v=20260923-2',
    data:'js/data.js?v=20260923-2',
    costLog:'js/cost-log.js?v=20260813-1',
    cuttingStore:'js/cutting-store.js?v=20260804-4',
    cutting:'js/cutting.js?v=20260923-2',
    pieceCuttingStore:'js/piece-cutting-store.js?v=20260906-1',
    pieceCutting:'js/piece-cutting.js?v=20260923-2',
    accounts:'js/accounts.js?v=20260813-2',
    orders:'js/orders.js?v=20260923-2',
    ...
    productionEntry:'js/production/production-entry.js?v=20260923-2',
    ...
    productionProductGroups:'js/production/product-groups.js?v=20260923-2',
    ...
    productionAnalysis:'js/production-analysis/production-analysis.js?v=20260923-2'
  }); // SCRIPT_URLS（功能程式網址）：修改功能檔時只更新對應版本。

  const STYLE_URLS = Object.freeze({
    cutting:'styles/features/cutting.css?v=20260923-2',
    pieceCutting:'styles/features/piece-cutting.css?v=20260923-2',
    orders:'styles/features/orders.css?v=20260923-2',
    inspectionReport:'styles/features/inspection-report.css?v=20260923-2',
    products:'styles/features/products.css?v=20260923-2',
    cost:'styles/features/cost.css?v=20260923-2',
    accounts:'styles/features/accounts.css?v=20260923-2',
    production:'styles/features/production.css?v=20260923-2',
    productionProcessEdit:'styles/features/production-process-edit.css?v=20260923-2',
    productionAnalysis:'styles/features/production-analysis.css?v=20260923-2',
    performanceBonus:'styles/features/performance-bonus.css?v=20260923-2',
    systemMonitor:'styles/features/system-monitor.css?v=20260923-2',
    productChangeLog:'styles/features/product-change-log.css?v=20260923-2'
