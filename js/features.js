...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    settings:'js/settings.js?v=20260922-26',
    uiTableControls:'js/ui-table-controls.js?v=20260922-26',
    uiSearchDropdown:'js/ui-search-dropdown.js?v=20260922-26',
    ...
    productImportImpact:'js/product-import-impact.js?v=20260922-26',
    productMasterEditor:'js/product-master-editor.js?v=20260922-26',
    productQuickEdit:'js/product-quick-edit.js?v=20260922-26',
    ...
    orderProductionProgress:'js/order-production-progress.js?v=20260922-26',
    summary:'js/summary.js?v=20260922-26',
    data:'js/data.js?v=20260922-26',
    costLog:'js/cost-log.js?v=20260813-1',
    cuttingStore:'js/cutting-store.js?v=20260804-4',
    cutting:'js/cutting.js?v=20260922-26',
    pieceCuttingStore:'js/piece-cutting-store.js?v=20260906-1',
    pieceCutting:'js/piece-cutting.js?v=20260922-26',
    accounts:'js/accounts.js?v=20260813-2',
    orders:'js/orders.js?v=20260922-26',
    ...
    productionEntry:'js/production/production-entry.js?v=20260922-26',
    ...
    productionProductGroups:'js/production/product-groups.js?v=20260922-26',
    ...
    productionAnalysis:'js/production-analysis/production-analysis.js?v=20260922-26'
  }); // SCRIPT_URLS（功能程式網址）：修改功能檔時只更新對應版本。

  const STYLE_URLS = Object.freeze({
    cutting:'styles/features/cutting.css?v=20260922-26',
    pieceCutting:'styles/features/piece-cutting.css?v=20260922-26',
    orders:'styles/features/orders.css?v=20260922-26',
    inspectionReport:'styles/features/inspection-report.css?v=20260922-26',
    products:'styles/features/products.css?v=20260922-26',
    cost:'styles/features/cost.css?v=20260922-26',
    accounts:'styles/features/accounts.css?v=20260922-26',
    production:'styles/features/production.css?v=20260922-26',
    productionProcessEdit:'styles/features/production-process-edit.css?v=20260922-26',
    productionAnalysis:'styles/features/production-analysis.css?v=20260922-26',
    performanceBonus:'styles/features/performance-bonus.css?v=20260922-26',
    systemMonitor:'styles/features/system-monitor.css?v=20260922-26',
    productChangeLog:'styles/features/product-change-log.css?v=20260922-26'
