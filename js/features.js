...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    orders:'js/orders.js?v=20260813-2',
    ...
    productionEntry:'js/production/production-entry.js?v=20260814-2',
    ...
    productionProcessSecondsQuickEdit:'js/production/process-seconds-quick-edit.js?v=20260813-6',
  ...
  const STYLE_URLS = Object.freeze({
    ...
    productionProcessEdit:'styles/features/production-process-edit.css?v=20260813-12',
