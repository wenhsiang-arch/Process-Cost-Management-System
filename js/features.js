...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    productModel:'js/product-model.js?v=20260824-4',
    ...
    productQuickEdit:'js/product-quick-edit.js?v=20260824-5',
    productGroupRuntime:'js/product-group-runtime.js?v=20260824-3',
    ...
    productionProcessGroupUi:'js/production/process-group-ui.js?v=20260824-4',
    productionProcessSecondsQuickEdit:'js/production/product-seconds-adapter.js?v=20260824-3',
    productionProductGroups:'js/production/product-groups.js?v=20260824-4',
