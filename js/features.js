...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    productionSummaryMigration:'js/production/summary-migration.js?v=20260817-4',
    ...
    performanceBonusMonthlyPage:'js/performance-bonus/monthly-bonus-page.js?v=20260817-4',
