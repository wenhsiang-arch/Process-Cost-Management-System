...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    productionEntry:'js/production/production-entry.js?v=20260810-6',
    productionRecords:'js/production/production-records.js?v=20260810-4',
    productionAttendance:'js/production/production-attendance.js?v=20260810-3',
    productionEmployees:'js/production/production-employees.js?v=20260810-4'
  ...
  const STYLE_URLS = Object.freeze({
    ...
    production:'styles/features/production.css?v=20260810-10'
