...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    productModel:'js/product-model.js?v=20260824-3',
    ...
    productQuickEdit:'js/product-quick-edit.js?v=20260824-3',
    ...
    summary:'js/summary.js?v=20260824-2',
    ...
    productionEntry:'js/production/production-entry.js?v=20260824-2',
    ...
    productionProcessSecondsQuickEdit:'js/production/product-seconds-adapter.js?v=20260824-2',
  ...
  const STYLE_URLS = Object.freeze({
    ...
    productionProcessEdit:'styles/features/production-process-edit.css?v=20260824-3',
