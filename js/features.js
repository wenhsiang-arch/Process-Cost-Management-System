...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    productQuickEdit:'js/product-quick-edit.js?v=20260824-2',
    ...
    productionProcessGroupUi:'js/production/process-group-ui.js?v=20260824-2',
  ...
  const STYLE_URLS = Object.freeze({
    ...
    products:'styles/features/products.css?v=20260824-4',
    ...
    productionProcessEdit:'styles/features/production-process-edit.css?v=20260824-2',
