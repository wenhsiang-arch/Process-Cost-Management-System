...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    orders:'js/orders.js?v=20260814-1',
    ...
    productionEntryStore:'js/production/entry-store.js?v=20260814-1',
    ...
    productionEntry:'js/production/production-entry.js?v=20260814-3',
    ...
    productionProcessEditStore:'js/production/process-edit-store.js?v=20260814-1',
    productionProcessGroupUi:'js/production/process-group-ui.js?v=20260813-5',
    productionProcessSecondsQuickEdit:'js/production/process-seconds-quick-edit.js?v=20260814-1',
    productionProcessEdit:'js/production/process-edit.js?v=20260814-1',
  ...
  const STYLE_URLS = Object.freeze({
    ...
    production:'styles/features/production.css?v=20260814-1',
    productionProcessEdit:'styles/features/production-process-edit.css?v=20260814-1',
