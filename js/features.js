...
(function(){
  const SCRIPT_URLS = Object.freeze({
    ...
    productionEntry:'js/production/production-entry.js?v=20260809-11',
    productionRecords:'js/production/production-records.js?v=20260809-5',
  ...
  const STYLE_URLS = Object.freeze({
    ...
    production:'styles/features/production.css?v=20260809-12'
