      ...
      <section id="pc-panel-order" class="pc-panel">
        ...
        <section id="pc-order-files-wrap" class="pc-result-table-group pc-order-files-wrap">
          ...
          <div class="pc-table-wrap ui-table-frame"><div class="pc-table-scroll ui-table-scroll" data-ui-floating-scroll="only"><table id="pc-order-files-table" class="pc-table ui-table pc-order-files-table" data-ui-table-controls="auto" data-ui-table-resizable="true" data-ui-table-sticky="original" data-ui-table-settings-target="#pc-order-files-tools"><thead><tr>
            <th data-ui-table-column="fileName" data-ui-table-width="360" data-ui-table-min-width="180" data-ui-table-max-width="520" data-ui-table-ellipsis="true"><span class="ui-dual-copy"><strong>Tên tệp</strong><span>檔名</span></span></th><th data-ui-table-column="order" data-ui-table-width="260" data-ui-table-min-width="150" data-ui-table-max-width="420" data-ui-table-ellipsis="true"><span class="ui-dual-copy"><strong>Đơn hàng</strong><span>訂單</span></span></th>
            <th class="ui-table-number-cell" data-ui-table-column="codeCount" data-ui-table-sort-type="number" data-ui-table-width="110" data-ui-table-min-width="90" data-ui-table-max-width="160"><span class="ui-dual-copy"><strong>Số mã</strong><span>款號數</span></span></th><th class="ui-table-number-cell" data-ui-table-column="quantity" data-ui-table-sort-type="number" data-ui-table-width="130" data-ui-table-min-width="105" data-ui-table-max-width="190"><span class="ui-dual-copy"><strong>Tổng số lượng</strong><span>總數量</span></span></th>
            <th class="ui-table-center-cell" data-ui-table-column="status" data-ui-table-width="130" data-ui-table-min-width="105" data-ui-table-max-width="180"><span class="ui-dual-copy"><strong>Tình trạng</strong><span>狀態</span></span></th><th class="ui-table-center-cell" data-ui-table-column="action" data-ui-table-sortable="false" data-ui-table-resizable="false" data-ui-table-width="105" data-ui-table-min-width="90" data-ui-table-max-width="130"><span class="ui-dual-copy"><strong>Thao tác</strong><span>操作</span></span></th>
        ...
        <section id="pc-order-items-wrap" class="pc-result-table-group">
          ...
          <div class="pc-table-wrap ui-table-frame"><div class="pc-table-scroll ui-table-scroll" data-ui-floating-scroll="only"><table id="pc-order-items-table" class="pc-table ui-table pc-order-items-table" data-ui-table-controls="auto" data-ui-table-resizable="true" data-ui-table-sticky="original" data-ui-table-settings-target="#pc-order-items-tools"><thead><tr>
            <th data-ui-table-column="fileName" data-ui-table-width="270" data-ui-table-min-width="170" data-ui-table-max-width="440" data-ui-table-ellipsis="true"><span class="ui-dual-copy"><strong>Tên tệp</strong><span>檔名</span></span></th><th data-ui-table-column="order" data-ui-table-width="220" data-ui-table-min-width="150" data-ui-table-max-width="360" data-ui-table-ellipsis="true"><span class="ui-dual-copy"><strong>Đơn hàng</strong><span>訂單</span></span></th>
            <th data-ui-table-column="code" data-ui-table-width="155" data-ui-table-min-width="120" data-ui-table-max-width="240"><span class="ui-dual-copy"><strong>Mã hàng</strong><span>款號</span></span></th><th class="ui-table-number-cell" data-ui-table-column="quantity" data-ui-table-sort-type="number" data-ui-table-width="120" data-ui-table-min-width="100" data-ui-table-max-width="170"><span class="ui-dual-copy"><strong>Số lượng</strong><span>訂單數量</span></span></th>
            <th class="ui-table-center-cell" data-ui-table-column="size" data-ui-table-width="95" data-ui-table-min-width="80" data-ui-table-max-width="150"><span class="ui-dual-copy"><strong>Size</strong><span>尺寸</span></span></th><th data-ui-table-column="material" data-ui-table-width="390" data-ui-table-min-width="210" data-ui-table-max-width="620" data-ui-table-ellipsis="true"><span class="ui-dual-copy"><strong>Vật liệu liên quan</strong><span>相關布料</span></span></th>
            <th class="ui-table-center-cell" data-ui-table-column="status" data-ui-table-width="135" data-ui-table-min-width="110" data-ui-table-max-width="190"><span class="ui-dual-copy"><strong>Tình trạng</strong><span>狀態</span></span></th></tr></thead><tbody id="pc-order-body"></tbody></table></div></div>
        </section>
          </div>
        </section>
      </section>
      <section id="pc-panel-template" class="pc-panel" hidden>
        ...
        <section class="pc-data-section ui-data-section">
          ...
          <div class="pc-table-frame ui-table-frame"><div class="pc-table-scroll ui-table-scroll" data-ui-floating-scroll="only"><table id="pc-template-table" class="pc-table ui-table pc-template-table" data-ui-table-controls="auto" data-ui-table-sticky="original"><thead><tr>
            <th><span class="ui-dual-copy"><strong>Tệp mẫu chính</strong><span>主檔檔案</span></span></th><th><span class="ui-dual-copy"><strong>Số mã</strong><span>款號數</span></span></th>
            <th><span class="ui-dual-copy"><strong>Số size</strong><span>尺寸數</span></span></th><th><span class="ui-dual-copy"><strong>Vật liệu</strong><span>布料數</span></span></th>
            <th><span class="ui-dual-copy"><strong>Bộ phận cắt</strong><span>裁片數</span></span></th><th><span class="ui-dual-copy"><strong>Tình trạng</strong><span>狀態</span></span></th>
