...
test('全系統正式功能預設使用緊湊桌機密度且保留可讀控制高度',()=>{
  ...
  assert.match(features,/products:'styles\/features\/products\.css\?v=20260824-3'/);
  assert.match(features,/productionProcessEdit:'styles\/features\/production-process-edit\.css\?v=20260824-1'/);
